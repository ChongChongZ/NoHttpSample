...
public class UploadFileActivity extends BaseActivity implements View.OnClickListener, HttpListener<String> {
    ...
    private void uploadFileNoHttp() {
        ...
        // 文件上传进度
        fileBinary1.setUploadListener(1, mProgressHandler);
        fileBinary2.setUploadListener(2, mProgressHandler);
    ...
    private OnUploadListener mProgressHandler=new OnUploadListener() {
        @Override
